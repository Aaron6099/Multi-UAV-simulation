function res = mpc_trio3_hover()
%MPC_TRIO3_HOVER  自包含 MPC 验证：三机等边三角 × 悬停
%
...
res = struct('formation','trio3','mode','hover','form_err',m_form, ...
...
xlabel('t [s]');
sgtitle(sprintf('trio3 × hover  →  %s  (form=%.3fm  track=%.3fm  minsp=%.2fm)', ...
