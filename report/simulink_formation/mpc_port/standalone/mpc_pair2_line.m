function res = mpc_pair2_line()
%MPC_PAIR2_LINE  自包含 MPC 验证：双机纵列 × 直线
%
...
res = struct('formation','pair2','mode','line','form_err',m_form, ...
...
title(sprintf('MPC pair2 line — 俯视轨迹'));
...
xlabel('t [s]');
sgtitle(sprintf('pair2 × line  →  %s  (form=%.3fm  track=%.3fm  minsp=%.2fm)', ...
